<<<<<<< HEAD
```{r echo=F}
setwd("C:/Users/User/Documents/metabolomics-courses/December2017/")
library(knitr)
...
# HMDB database
hmdb <- read.table("./data/HMDB_17_09.txt",header=T,sep="\t",stringsAsFactors=F,fill=T,quote="")

# list of significant features' m/z
input <- feature.msms$mzmed
# ppm error to perform the search. Instrument dependant (e.g. orbitrap 2-6; qTOF 8-12)
ppm <- 10
